...
public sealed class BitWriter : IBitWriter, IDisposable
{
    ...
    public void WriteUInt16(uint value, int numberOfBits) => WriteUInt16((ushort)value, numberOfBits);
	public void WriteUInt16(int value, int numberOfBits) => WriteUInt16((ushort)value, numberOfBits);
	public void WriteUInt16(ushort value) => WriteUInt16(value, sizeof(ushort) * 8);
	public void WriteUInt16(uint value) => WriteUInt16((ushort)value, sizeof(ushort) * 8);
	public void WriteUInt16(int value) => WriteUInt16((ushort)value, sizeof(ushort) * 8);
